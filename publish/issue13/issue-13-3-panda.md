...
<img src="https://objccn.io/images/issue-13/cornerRadius.png" width="260">


当在 Interface Builder 中创建行为时，你将重度依赖运行时属性去设置行为选项。最终将会带来更多的典型运行时属性：

<img src="https://objccn.io/images/issue-13/runtimeAttributes.png" width="253">
...
<video controls="1" style="display:block;max-width:100%;height:auto;border:0;">
  <source src="https://objccn.io/images/issue-13/parallaxAnimationBehaviour.mp4">
</video>

或者需要从你的相册或者相机中获取一张图片？

<video controls="1" style="display:block;max-width:100%;height:auto;border:0;">
  <source src="https://objccn.io/images/issue-13/imagePickerBehaviour.mp4">
</video>
