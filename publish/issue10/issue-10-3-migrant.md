...
![NSDocument 为管理应用的已同步文档所提供的简单界面](https://objccn.io/images/issue-10/Open.png)
...
![”~/Library/Mobile Documents“的内容，它包含了每个应用开放性容器所分别对应的文件夹](https://objccn.io/images/issue-10/Mobile%20Documents.png)
